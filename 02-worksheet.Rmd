...
You may want to consult Twitter's [User Data Dictionary](https://developer.twitter.com/en/docs/tweets/data-dictionary/overview/user-object) to examine the field names and their defintions. Having a familiarity with these fields will help you to develop questions to explore. 
...
How many tweets were there in total?
